...
namespace Gley.TrafficSystem.Editor
{
    public class IntersectionDrawer : SetupWindowBase
    {
        ...
        public static void DrawIntersectionWaypoint(WaypointSettingsBase waypoint, Color drawColor, int road, Color textColor, float size)
        {
            if (waypoint != null)
            {
        ...
        public static void DrawListWaypoints<T>(List<T> waypointList, Color drawColor, int road, Color textColor, float size) where T : WaypointSettingsBase
        {

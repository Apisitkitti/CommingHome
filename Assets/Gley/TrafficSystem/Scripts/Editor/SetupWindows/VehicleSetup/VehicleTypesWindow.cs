...
namespace Gley.TrafficSystem.Editor
{
    public class VehicleTypesWindow : SetupWindowBase
    {
        ...
        private void Save()
        {
            FileCreator.CreateVehicleTypesFile<VehicleTypes>(carCategories, Internal.Constants.GLEY_TRAFFIC_SYSTEM, Internal.Constants.trafficNamespace, Internal.Constants.agentTypesPath);
        }

...
namespace Gley.TrafficSystem.Editor
{
    public class ShowVehicleTypeEditedWaypoints : ShowWaypointsTrafficBase
    {
        ...
        {
            return waypointDrawer.ShowCarTypeEditedWaypoints(roadColors.waypointColor, save.showConnections, roadColors.waypointColor, save.showSpeed, roadColors.speedColor, save.showCars, roadColors.carsColor, save.showOtherLanes, roadColors.laneChangeColor, save.showPriority, roadColors.priorityColor).Cast<WaypointSettingsBase>().ToList();
        }
    }
}

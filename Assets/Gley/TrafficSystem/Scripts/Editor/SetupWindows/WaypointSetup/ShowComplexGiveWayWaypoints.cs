...
namespace Gley.TrafficSystem.Editor
{
    public class ShowComplexGiveWayWaypoints : ShowWaypointsTrafficBase
    {
        ...
        {
            return waypointDrawer.ShowComplexGiveWayWaypoints(roadColors.waypointColor, save.showConnections, roadColors.waypointColor, save.showSpeed, roadColors.speedColor, save.showCars, roadColors.carsColor, save.showOtherLanes, roadColors.laneChangeColor, save.showPriority, roadColors.priorityColor).Cast<WaypointSettingsBase>().ToList();
        }
    }
}

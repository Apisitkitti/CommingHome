...
namespace Gley.TrafficSystem.Editor
{
    public class ShowDisconnectedWaypoints : ShowWaypointsTrafficBase
    {
        ...
        {
            return waypointDrawer.ShowDisconnectedWaypoints(roadColors.waypointColor, save.showConnections, roadColors.waypointColor, save.showSpeed, roadColors.speedColor, save.showCars, roadColors.carsColor, save.showPriority, roadColors.priorityColor);
        }
    }
}
